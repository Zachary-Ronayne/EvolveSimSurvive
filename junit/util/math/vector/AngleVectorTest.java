...
public class AngleVectorTest{
	...
	private AngleVector vector;
	
	@Before
	public void setUp(){
		vector = new AngleVector(2.45296, 4.61069);
	}
	...
	public void testSaveLoad(){
		Vector load = new AngleVector(0, 0);
		
		File loc = new File(Main.DATA_PATH + "AngleVectorSaveTest.txt");
		try{
